<template>
    <a :href="itemLink" class="rounded-6 w-100 me-3" style="cursor: pointer;">
        <div class="card-img-top bg-image position-relative" :style="{ backgroundImage: `url('/images/home/t-2.png')` }">
        </div>
        ...
        <div class="d-flex flex-column align-items-start p-0 py-1" @click.prevent="goToDetail">
            ...
            <h5 class="card-title text-black fs-3 m-0 mt-1 mt-lg-2 mt-md-2">Lil-Star Launches A Natural Beauty Line for
                Babies That You Want To Steal</h5>
            <p class="card-text text-start text-black py-2">Lorem ipsum is placeholder text commonly used in the graphic,

...
export function useSmaugItemsV2Controller(
    ...
    // const defaultPaginationParamsV2 = {
    //     query: "",
    //     categories: [],
    //     attributes: {
    //         Color: [],
    ...
    function constructPaginationParams(params) {
        ...
        if (!params) {
            ...
            if (params.sortParams && params.sortParams.length > 0) {
                // params.sortParams.forEach((element) => {
            ...
            // if (params.rangeParams && params.rangeParams.length > 0) {
            //     for (let i = 0; i < params.rangeParams.length; i++) {
            //         let element = params.rangeParams[i];
            //         if (element.field && element.field != '') {
            //             obj.rangeParams.push(element);
            //         }
            //     }
            // }

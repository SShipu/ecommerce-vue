   ...
   <div class="success-main">
       ...
       <div class="right-side-area">
           <div class="left-side-area">
            ...
            <div class="invoice-id-para-area">
                <p >Please contact our customer support immediately. Your Invoice id is <strong>{{ invoiceId }}</strong></p>
            </div>
...
const failureCall = (id, invoiceId) => {
    let data = {
        id: invoiceId,
    }
    ordersPlaceClient
        .failurePayment(data, orderType.value)
        .then((res) => {
...
watch(route, ()=> {
    ...
    failureCall(route.query.id, route.query.invoiceId);
}, {immediate: true});
</script>
